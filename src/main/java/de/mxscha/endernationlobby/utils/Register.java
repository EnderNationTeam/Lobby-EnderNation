...
import de.mxscha.endernationlobby.listener.items.*;
...
public class Register {
    ...
    public static void init(LobbyCore core) {
        ...
        manager.registerEvents(new ServerWechslerListener(), core);
        ...
        manager.registerEvents(new DoubleJumpListener(), core);
        // Settings
